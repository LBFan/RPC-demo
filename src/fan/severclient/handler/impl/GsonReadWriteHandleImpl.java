...
public class GsonReadWriteHandleImpl implements ReadWriteHandle {
    private DataOutputStream dos;
    private DataInputStream dis;

    public GsonReadWriteHandleImpl() {
    }

    public GsonReadWriteHandleImpl(DataOutputStream dos, DataInputStream dis) {
        this.dos = dos;
        this.dis = dis;
    }
